...
int SocketDatagrama::recibe(PaqueteDatagrama &p)
{
	...
	int i = recvfrom(s, (char *)p.obtieneDatos(), p.obtieneLongitud() * sizeof(char), 0, (struct sockaddr *)&direccionForanea, &len);
...
int SocketDatagrama::recibeTimeout(PaqueteDatagrama &p, time_t segundos, suseconds_t microsegundos){
	...
	*/
	...
	if (i < 0){		// Si el tiempo acabó, regresar -1
		if (errno == EWOULDBLOCK)
		{
			cout<<"Tiempo para recepción transcurrido"<<endl;
			return -1;
		}
		else
		{
