...
//y va a ejecutar ese número de depósitos de una cantidad

int main(int argc, char *argv[])
{
	//El cliente que recibe en la línea de comandos un entero n...
	if (argc != 4)
	{
	...
	//y va a ejecutar ese número de depósitos...
	while (cont < n)
	{
		//de una cantidad aleatoria de pesos comprendida entre $1 y $9 sobre la cuenta.
		int arr = 1 + rand() % 9;
		cuenta = cuenta + arr;
